...
                            <h3 class="name"><?php  get_post_meta( get_the_ID(), 'testi_name', true ); ?></h3>
                            <span class="post"><?php get_post_meta( get_the_ID(), 'test_desig', true ); ?></span>
                        </div>
                        <ul class="rating">
<?php $bwqt_client_review = get_post_meta( get_the_ID(), 'test_rating', true ); 
